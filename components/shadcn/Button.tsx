  ...
  "inline-flex items-center justify-center whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        violetWithOutline: "bg-violet-500 outline outline-offset-4 outline-4 outline-violet-500 text-white hover:bg-violet/90",
        destructive:
      ...
      size: {
        ...
        smCircle: "h-10 w-10 rounded-full",
        mdCircle: "h-16 w-16 rounded-full",
        lgCircle: "h-24 w-24 rounded-full",
      },
    },
    defaultVariants: {
      variant: "default",
